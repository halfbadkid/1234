...
# -------------------------
# UNIVERSITY LOGO (Main Header)
# -------------------------
col1, col2, col3, col4, col5 = st.columns([1, 1, 2, 1, 1])
with col3:
    st.image("umpsa_logo.png", width=220)
...
st.markdown("""<p style='text-align: center; color: gray;'> An accurate and unbiased loan approval platform that empowers users to check their eligibility through transparent and trustworthy decision-making.</p>""", unsafe_allow_html=True)
